...
function theme_script() {
    ...
    // wp_enqueue_script('custom_script', get_template_directory_uri() . '/assets/js/wow.js');
    wp_enqueue_script('custom_script', get_template_directory_uri() . '/assets/js/scripts.js' ,'','', false);
}
