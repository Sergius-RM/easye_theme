...
<section class="blogrid_articles">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-xl-<?php echo $colnumber;?>" id="post-<?php the_ID(); ?>" id="post-<?php the_ID(); ?>">
                <div class="articles-item">
                    ...
                    <div class="articles-content">
                        <h4><a href="<?php the_permalink(); ?>"><?php echo substr(strip_tags(get_the_title()), 0, 120); ?></a></h4>
